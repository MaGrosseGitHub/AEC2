...
<form action="<?php echo Router::url('admin/events/edit/'.$id); ?>" method="post">
  ...
  <?php echo $this->Form->input('auteur','hidden', array('inputValue'=>'user2')); ?>
  <?php echo $this->Form->input('id','hidden'); ?>
  <?php echo $this->Form->input('description','Description de l\'évement',array('type'=>'textarea','class'=>'xxlarge wysiwyg','rows'=>5)); ?>
	<?php echo $this->Form->input('fromDate','Debut',array('class'=>'datepicker timestamp')); ?>
  <?php echo $this->Form->input('toDate','Fin',array('class'=>'datepicker timestamp')); ?>
	<div class="actions">
