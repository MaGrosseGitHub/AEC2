  ...
  ////////////////////////////////////////////////////////////////////////////////////////  
    ...
    function createMarker($map, $options) {
      ...
      if(exists($options)){
        ...
        if(exists($options.labelOptions)){
          ...
          if(exists($options.eventType)){
            if($options.eventType ==  "club" || $options.eventType == "event"){
              $labelOptionsDefault.labelAnchor = clubLabelPos;
            }
            if(exists($options.closest) && $options.closest) {
              if($options.eventType ==  "club" || $options.eventType == "event"){
                $labelOptionsDefault.labelAnchor = clubClosestLabelPos;
              } else{
                $labelOptionsDefault.labelAnchor = defaultClosestLabelPos;
              }
            }
          }
      ...
      if(exists($options.type)){
        ...
        // $type = $options.type;
        // if($type == "parapente"){
        //   $options.iconOptions.fillColor = parapenteColor;
        // } else if($type == "parachute"){
        //   $options.iconOptions.fillColor = parachuteColor;
        // } else if($type == "aviation"){
        //   $options.iconOptions.fillColor = aviationColor;
        // }
      }
