...
<?php echo HTML::JS("src/redist/when"); ?>
<?php echo HTML::JS("src/core"); ?>
<?php echo HTML::JS("src/graphics"); ?>
<?php echo HTML::JS("src/mapimage"); ?>
<?php echo HTML::JS("src/mapdata"); ?>
<?php echo HTML::JS("src/areadata"); ?>
<?php echo HTML::JS("src/areacorners"); ?>
<?php echo HTML::JS("src/scale"); ?>
<?php echo HTML::JS("src/tooltip"); ?>
