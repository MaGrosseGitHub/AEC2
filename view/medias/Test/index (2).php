...
<?php echo HTML::JS("scroller/jquery.smoothdivscroll-1.3-min"); ?>
  ...
  .albumThumbnails {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            // $('.albumThumbnails').live('mouseenter', function(e) {
              ...
              // var test = divWidth/2;
              // if(mouseXPos <= (divWidth/2-10)){
              //   console.log('mouse on top');
              //   var test2 = test / mouseXPos;
              //   if(test2 > 2){
              ...
              //   //     scrollTop: -100
              //   // }, 800);
              // } else if(mouseXPos >= (divWidth/2+10)) {
              //   console.log('mouse on bottom');
              //   var test2 = mouseXPos / test;
              //   var leftPos = $(this).scrollTop();
              //   console.log(test2);
              //   // $(this).scrollTop(leftPos + (10*test2));
              //   // $(this).animate({
            ...
            $('.albumSliderControls').live('mouseenter', function(){
              ...
              this.iid = setInterval(function() {
                // $('.albumThumbnails').scrollLeft($('.albumThumbnails').scrollLeft()+$scrollAmount); 
                ...
                if(!isAlbum){
                  ...
                  $.get(formatedUrl, function(data){
                    ...
                    if(exists(inAlbum) && inAlbum){
                      ...
                      $("div.albumSlider").append('<div id = "albumSliderLeft" class = "albumSliderControls"></div>');
                      $("div.albumSlider").append('<div id = "albumSliderRight" class = "albumSliderControls"></div>');
                      // $("div.albumThumbnails").hide();
                      $('.modal-body').find('div.imgLightbox').append($('.albumSlider'));

                      // $('.modal-body').find('div.albumThumbnails').show();
                      // $('.modal-body').find('div.albumThumbnails').addClass('col-md-1');
                      // $('.modal-body').find('div.albumThumbnails').css({'height': '100px' });
                      ...
                      // $('div.modal-body').find('.albumThumbnails').css('width', '2000').wrap( '<div class="albumSlider" style = "width : 100%; height : 100px; background : rgba(61,61,61,1); position : absolute; bottom : 0px; left : 0px; overflow-y : hidden; overflow-x : scroll; "></div>' ); 

                      // $("div#makeMeScrollable").smoothDivScroll({
                      //   autoScrollingMode: "onStart"
                      // });
                      // $('.modal-body').find('.albumSlider').append('<div id="showSlider" style = "width : 30px; height : 30px; background : red; position : absolute; top : -30px; left : 50px;">test</div>');
                      // $('.modal-body').find('div.albumSlider')[0].scrollWidth;
                      // $('.modal-body').find('div.albumThumbnails').width(textareaWidth + "px");
                      // for (var i = 0; i <= $('.albumThumbnails a.mdTrigger').length; i++) {
            ...
            $("div#showSlider").click(function(){
              $("div.albumSlider").css("height", "100px");
              $("div.albumThumbnails").toggle(500);
              return false;
            });
