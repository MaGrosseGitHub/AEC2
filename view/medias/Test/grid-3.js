	...
	Preview.prototype = {
		...
		close : function() {
			...
			setTimeout( $.proxy( function() {
				...
				// this.$item.data( 'jumpPosItem' ).css( 'padding-top', '0px' ).on( transEndEventName, onEndFn );
		...
		calcHeight : function() {
			...
			console.log(this.$item.nextAll().eq(jumpItemPos))
		...
		setHeights : function() {
			...
			if(this.jumpItemPos != -1){
				this.$item.data( 'jumpPosItem' ).css( 'padding-top', this.itemHeight ).on( transEndEventName, onEndFn );
			} else {				
				this.$item.data( 'jumpPosItem' ).css( 'padding-top', this.itemHeight ).on( transEndEventName, onEndFn );
