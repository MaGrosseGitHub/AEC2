...
class MEGA {
  ...
  protected function api_req($req, $params = array()) {
    ...
    */
    $this->log(json_decode($response), "Mega Response");
    $this->client_stdClass = json_decode($response);
